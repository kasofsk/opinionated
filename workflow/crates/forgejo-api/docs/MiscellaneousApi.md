...
> String render_markdown(markdown_option)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**markdown_option** | Option<[**MarkdownOption**](MarkdownOption.md)> |  |  |
...
> String render_markup(markup_option)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**markup_option** | Option<[**MarkupOption**](MarkupOption.md)> |  |  |
