...
> Vec<models::Label> issue_add_label(owner, repo, index, issue_labels_option)
...
**issue_labels_option** | Option<[**IssueLabelsOption**](IssueLabelsOption.md)> |  |  |
...
> models::TrackedTime issue_add_time(owner, repo, index, add_time_option)
...
**repo** | **String** | name of the repo | [required] |
**index** | **i64** | index of the issue | [required] |
**add_time_option** | Option<[**AddTimeOption**](AddTimeOption.md)> |  |  |
...
> issue_clear_labels(owner, repo, index, delete_labels_option)
...
**repo** | **String** | name of the repo | [required] |
**index** | **i64** | index of the issue | [required] |
**delete_labels_option** | Option<[**DeleteLabelsOption**](DeleteLabelsOption.md)> |  |  |
...
> models::Comment issue_create_comment(owner, repo, index, create_issue_comment_option)
...
**repo** | **String** | name of the repo | [required] |
**index** | **i64** | index of the issue | [required] |
**create_issue_comment_option** | Option<[**CreateIssueCommentOption**](CreateIssueCommentOption.md)> |  |  |
...
> models::Issue issue_create_issue(owner, repo, create_issue_option)
...
**owner** | **String** | owner of the repo | [required] |
**repo** | **String** | name of the repo | [required] |
**create_issue_option** | Option<[**CreateIssueOption**](CreateIssueOption.md)> |  |  |
...
> models::Attachment issue_create_issue_attachment(owner, repo, index, attachment, name, updated_at)
...
**updated_at** | Option<**String**> | time of the attachment's creation. This is a timestamp in RFC 3339 format |  |
...
> models::Issue issue_create_issue_blocking(owner, repo, index, issue_meta)
...
**repo** | **String** | name of the repo | [required] |
**index** | **i64** | index of the issue | [required] |
**issue_meta** | Option<[**IssueMeta**](IssueMeta.md)> |  |  |
...
> models::Attachment issue_create_issue_comment_attachment(owner, repo, id, attachment, name, updated_at)
...
> models::Issue issue_create_issue_dependencies(owner, repo, index, issue_meta)
...
> models::Label issue_create_label(owner, repo, create_label_option)
Create a label
...
> models::Milestone issue_create_milestone(owner, repo, create_milestone_option)
Create a milestone
...
**owner** | **String** | owner of the repo | [required] |
**repo** | **String** | name of the repo | [required] |
**create_milestone_option** | Option<[**CreateMilestoneOption**](CreateMilestoneOption.md)> |  |  |
...
> issue_delete_comment_reaction(owner, repo, id, edit_reaction_option)
...
**edit_reaction_option** | Option<[**EditReactionOption**](EditReactionOption.md)> |  |  |
...
> issue_delete_issue_reaction(owner, repo, index, edit_reaction_option)
...
**owner** | **String** | owner of the repo | [required] |
**repo** | **String** | name of the repo | [required] |
**id** | **i64** | the milestone to delete, identified by ID and if not available by name | [required] |
...
> models::Comment issue_edit_comment(owner, repo, id, edit_issue_comment_option)
Edit a comment
...
**repo** | **String** | name of the repo | [required] |
**id** | **i64** | id of the comment to edit | [required] |
**edit_issue_comment_option** | Option<[**EditIssueCommentOption**](EditIssueCommentOption.md)> |  |  |
...
> models::Comment issue_edit_comment_deprecated(owner, repo, index, id, edit_issue_comment_option)
Edit a comment
...
> models::Issue issue_edit_issue(owner, repo, index, edit_issue_option)
...
**edit_issue_option** | Option<[**EditIssueOption**](EditIssueOption.md)> |  |  |
...
> models::Attachment issue_edit_issue_attachment(owner, repo, index, attachment_id, edit_attachment_options)
...
> models::Attachment issue_edit_issue_comment_attachment(owner, repo, id, attachment_id, edit_attachment_options)
...
> models::IssueDeadline issue_edit_issue_deadline(owner, repo, index, edit_deadline_option)
...
**edit_deadline_option** | Option<[**EditDeadlineOption**](EditDeadlineOption.md)> |  |  |
...
> models::Label issue_edit_label(owner, repo, id, edit_label_option)
Update a label
...
> models::Milestone issue_edit_milestone(owner, repo, id, edit_milestone_option)
Update a milestone
...
**owner** | **String** | owner of the repo | [required] |
**repo** | **String** | name of the repo | [required] |
**id** | **i64** | the milestone to edit, identified by ID and if not available by name | [required] |
**edit_milestone_option** | Option<[**EditMilestoneOption**](EditMilestoneOption.md)> |  |  |
...
**owner** | **String** | owner of the repo | [required] |
**repo** | **String** | name of the repo | [required] |
**id** | **i64** | the milestone to get, identified by ID and if not available by name | [required] |
...
> Vec<models::Issue> issue_list_issues(owner, repo, state, labels, q, r#type, milestones, since, before, created_by, assigned_by, mentioned_by, page, limit, sort)
...
**page** | Option<**i32**> | page number of results to return (1-based) |  |
**limit** | Option<**i32**> | page size of results |  |
**sort** | Option<**String**> | Type of sort |  |[default to latest]
...
> Vec<models::Label> issue_list_labels(owner, repo, sort, page, limit)
...
> models::Reaction issue_post_comment_reaction(owner, repo, id, edit_reaction_option)
...
> models::Reaction issue_post_issue_reaction(owner, repo, index, edit_reaction_option)
...
> models::Issue issue_remove_issue_blocking(owner, repo, index, issue_meta)
...
> models::Issue issue_remove_issue_dependencies(owner, repo, index, issue_meta)
...
> issue_remove_label(owner, repo, index, identifier, delete_labels_option)
...
**repo** | **String** | name of the repo | [required] |
**index** | **i64** | index of the issue | [required] |
**identifier** | **String** | name or id of the label to remove | [required] |
**delete_labels_option** | Option<[**DeleteLabelsOption**](DeleteLabelsOption.md)> |  |  |
...
> Vec<models::Label> issue_replace_labels(owner, repo, index, issue_labels_option)
...
> Vec<models::Issue> issue_search_issues(state, labels, milestones, q, priority_repo_id, r#type, since, before, assigned, created, mentioned, review_requested, reviewed, owner, team, page, limit, sort)
