...
**default_merge_style** | Option<**String**> | set to a merge style to be used by this repository: \"merge\", \"rebase\", \"rebase-merge\", \"squash\", \"fast-forward-only\", \"manually-merged\", or \"rebase-update-only\". | [optional]
**default_update_style** | Option<**String**> | set to a update style to be used by this repository: \"rebase\" or \"merge\" | [optional]
...
**globally_editable_wiki** | Option<**bool**> | set the globally editable state of the wiki | [optional]
...
**wiki_branch** | Option<**String**> | sets the branch used for this repository's wiki. | [optional]
