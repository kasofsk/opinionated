# Rust API client for forgejo-api
...
- API version: 14.0.3+gitea-1.22.0
- Package version: 14.0.3+gitea-1.22.0
- Generator version: 7.21.0-SNAPSHOT
- Build package: `org.openapitools.codegen.languages.RustClientCodegen`

## Installation

Put the package under your project folder in a directory named `forgejo-api` and add the following to `Cargo.toml` under `[dependencies]`:
...
*ActivitypubApi* | [**activitypub_instance_actor_outbox**](docs/ActivitypubApi.md#activitypub_instance_actor_outbox) | **POST** /activitypub/actor/outbox | Display the outbox (always empty)
*ActivitypubApi* | [**activitypub_person**](docs/ActivitypubApi.md#activitypub_person) | **GET** /activitypub/user-id/{user_id} | Returns the Person actor for a user
*ActivitypubApi* | [**activitypub_person_activity**](docs/ActivitypubApi.md#activitypub_person_activity) | **GET** /activitypub/user-id/{user_id}/activities/{activity_id}/activity | Get a specific activity of the user
*ActivitypubApi* | [**activitypub_person_activity_note**](docs/ActivitypubApi.md#activitypub_person_activity_note) | **GET** /activitypub/user-id/{user_id}/activities/{activity_id} | Get a specific activity object of the user
*ActivitypubApi* | [**activitypub_person_feed**](docs/ActivitypubApi.md#activitypub_person_feed) | **GET** /activitypub/user-id/{user_id}/outbox | List the user's recorded activity
*ActivitypubApi* | [**activitypub_person_inbox**](docs/ActivitypubApi.md#activitypub_person_inbox) | **POST** /activitypub/user-id/{user_id}/inbox | Send to the inbox
*ActivitypubApi* | [**activitypub_repository**](docs/ActivitypubApi.md#activitypub_repository) | **GET** /activitypub/repository-id/{repository_id} | Returns the Repository actor for a repo
*ActivitypubApi* | [**activitypub_repository_inbox**](docs/ActivitypubApi.md#activitypub_repository_inbox) | **POST** /activitypub/repository-id/{repository_id}/inbox | Send to the inbox
*ActivitypubApi* | [**activitypub_repository_outbox**](docs/ActivitypubApi.md#activitypub_repository_outbox) | **POST** /activitypub/repository-id/{repository_id}/outbox | Display the outbox
...
*AdminApi* | [**admin_delete_quota_rule**](docs/AdminApi.md#admin_delete_quota_rule) | **DELETE** /admin/quota/rules/{quotarule} | Deletes a quota rule
...
*AdminApi* | [**admin_delete_user_emails**](docs/AdminApi.md#admin_delete_user_emails) | **DELETE** /admin/users/{username}/emails | Delete email addresses from a user's account
...
*AdminApi* | [**admin_list_user_emails**](docs/AdminApi.md#admin_list_user_emails) | **GET** /admin/users/{username}/emails | List all email addresses for a user
...
*RepositoryApi* | [**get_blobs**](docs/RepositoryApi.md#get_blobs) | **GET** /repos/{owner}/{repo}/git/blobs | Gets multiple blobs of a repository.
...
*UserApi* | [**user_create_token**](docs/UserApi.md#user_create_token) | **POST** /users/{username}/tokens | Generate an access token for the specified user
...
*UserApi* | [**user_delete_access_token**](docs/UserApi.md#user_delete_access_token) | **DELETE** /users/{username}/tokens/{token} | Delete an access token from the specified user's account
...
*UserApi* | [**user_get_tokens**](docs/UserApi.md#user_get_tokens) | **GET** /users/{username}/tokens | List the specified user's access tokens
